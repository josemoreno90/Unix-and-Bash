...
# question: How do rm nonexistent and rm -f nonexistent differ for a nonexistent file?
# answer: rm by itself will ask for comfirmation before deleting the files, where as rm -f will not ask for confirmation.
